 ...
 */
@Generated("")
@GraphQLName("DefaultSettingEntity")
@JsonFilter("Liferay.Vulcan")
@Schema(requiredProperties = {"defaultSettingId", "classId", "className"})
@XmlRootElement(name = "DefaultSettingEntity")
public class DefaultSettingEntity implements Serializable {

	public static DefaultSettingEntity toDTO(String json) {
		return ObjectMapperUtil.readValue(DefaultSettingEntity.class, json);
	}

	public static DefaultSettingEntity unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(
			DefaultSettingEntity.class, json);
	}
	...
	@Schema(
		...
		defaultValue = "com.liferay.commerce.qualifier.rest.dto.v1_0.DefaultSettingEntity",
		name = "x-class-name"
	)
