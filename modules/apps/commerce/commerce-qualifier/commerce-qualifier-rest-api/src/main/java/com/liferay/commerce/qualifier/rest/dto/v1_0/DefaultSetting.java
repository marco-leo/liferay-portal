 ...
 */
@Generated("")
@GraphQLName("DefaultSetting")
@JsonFilter("Liferay.Vulcan")
@Schema(requiredProperties = {"name"})
@XmlRootElement(name = "DefaultSetting")
public class DefaultSetting implements Serializable {

	public static DefaultSetting toDTO(String json) {
		return ObjectMapperUtil.readValue(DefaultSetting.class, json);
	}

	public static DefaultSetting unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(DefaultSetting.class, json);
	}
	...
	public String toString() {
		...
		if (defaultSettingEntities != null) {
			...
			for (int i = 0; i < defaultSettingEntities.length; i++) {
				sb.append(String.valueOf(defaultSettingEntities[i]));

				if ((i + 1) < defaultSettingEntities.length) {
					sb.append(", ");
				}
			}
	...
	@Schema(
		...
		defaultValue = "com.liferay.commerce.qualifier.rest.dto.v1_0.DefaultSetting",
		name = "x-class-name"
	)
