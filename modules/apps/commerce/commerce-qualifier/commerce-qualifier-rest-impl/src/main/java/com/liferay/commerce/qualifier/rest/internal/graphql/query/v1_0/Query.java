...
public class Query {
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -H 'Content-Type: text/plain; charset=utf-8' -X 'POST' 'http://localhost:8080/o/graphql' -d $'{"query": "query {qualifierIdQualifierEntity(id: ___){externalReferenceCode, id, info1, info2, info3, info4, info5, name, targetDefault, type}}"}' -u 'test@liferay.com:test'
	 */
	@GraphQLField
