...
public class CommerceDefaultSettingRelModelListener
	extends BaseModelListener<CommerceDefaultSettingRel> {
	...
	public void onBeforeRemove(
		...
		try {
			_cleanCommerceQualifierEntryCache(
				commerceDefaultSettingRel.getCompanyId(),
	...
	private static final Log _log = LogFactoryUtil.getLog(
		CommerceDefaultSettingRelModelListener.class);
