...
/**
 * Provides the local service interface for CommerceDefaultSetting. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Riccardo Alberti
 * @see CommerceDefaultSettingLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface CommerceDefaultSettingLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.liferay.commerce.qualifier.service.impl.CommerceDefaultSettingLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the commerce default setting local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link CommerceDefaultSettingLocalServiceUtil} if injection and service tracking are not available.
	 */
