...
/**
 * Provides the local service interface for CommerceDefaultSettingRel. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Riccardo Alberti
 * @see CommerceDefaultSettingRelLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface CommerceDefaultSettingRelLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.liferay.commerce.qualifier.service.impl.CommerceDefaultSettingRelLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the commerce default setting rel local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link CommerceDefaultSettingRelLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public CommerceDefaultSettingRel createCommerceDefaultSettingRel(
	...
	public CommerceDefaultSettingRel deleteCommerceDefaultSettingRel(
		CommerceDefaultSettingRel commerceDefaultSettingRel);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public CommerceDefaultSettingRel fetchCommerceDefaultSettingRel(
		long commerceDefaultSettingRelId);
