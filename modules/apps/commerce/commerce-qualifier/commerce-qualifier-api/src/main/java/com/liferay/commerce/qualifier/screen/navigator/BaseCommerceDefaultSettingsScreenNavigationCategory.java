...
import com.liferay.commerce.qualifier.display.context.CommerceDefaultSettingsDisplayContext;
 ...
 */
public abstract class BaseCommerceDefaultSettingsScreenNavigationCategory<T>
	implements ScreenNavigationCategory, ScreenNavigationEntry<T> {

	@Override
	public String getCategoryKey() {
		return "commerce-default-settings";
	}
	...
	public String getLabel(Locale locale) {
		...
		return LanguageUtil.get(resourceBundle, "commerce-default-settings");
	}

	public abstract String getTargetClassPKParamName();
	...
	public void render(
		...
		httpServletRequest.setAttribute(
			...
			new CommerceDefaultSettingsDisplayContext(
				commerceQualifierEntryService,
				commerceQualifierMetadataRegistry, getTargetName(),
				ParamUtil.getLong(
					httpServletRequest, getTargetClassPKParamName()),
				httpServletRequest));

		jspRenderer.renderJSP(
			servletContext, httpServletRequest, httpServletResponse,
			"/default_settings.jsp");
	}
