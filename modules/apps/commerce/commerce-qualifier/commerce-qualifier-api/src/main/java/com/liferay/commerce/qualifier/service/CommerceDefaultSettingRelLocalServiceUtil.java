...
/**
 * Provides the local service utility for CommerceDefaultSettingRel. This utility wraps
 * <code>com.liferay.commerce.qualifier.service.impl.CommerceDefaultSettingRelLocalServiceImpl</code> and
 ...
 * @generated
 */
public class CommerceDefaultSettingRelLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.liferay.commerce.qualifier.service.impl.CommerceDefaultSettingRelLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static CommerceDefaultSettingRel createCommerceDefaultSettingRel(
		long commerceDefaultSettingRelId) {

		return getService().createCommerceDefaultSettingRel(
	 ...
	 */
	public static CommerceDefaultSettingRel deleteCommerceDefaultSettingRel(
		CommerceDefaultSettingRel commerceDefaultSettingRel) {

		return getService().deleteCommerceDefaultSettingRel(
			commerceDefaultSettingRel);
	}
	...
	public static void deleteCommerceDefaultSettingRels(
		...
		getService().deleteCommerceDefaultSettingRels(className, classPK);
	}
	...
	public static CommerceDefaultSettingRel fetchCommerceDefaultSettingRel(
		long commerceDefaultSettingRelId) {

		return getService().fetchCommerceDefaultSettingRel(
			commerceDefaultSettingRelId);
	}
	...
	public static List<CommerceDefaultSettingRel> getCommerceDefaultSettingRels(
		...
		return getService().getCommerceDefaultSettingRels(start, end);
	}
	 ...
	 */
	public static int getCommerceDefaultSettingRelsCount() {
		return getService().getCommerceDefaultSettingRelsCount();
	}
	...
	public static CommerceDefaultSettingRelLocalService getService() {
		return _service;
	}

	private static volatile CommerceDefaultSettingRelLocalService _service;
