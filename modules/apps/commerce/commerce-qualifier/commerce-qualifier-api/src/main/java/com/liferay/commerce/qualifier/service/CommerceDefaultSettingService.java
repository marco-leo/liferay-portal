...
/**
 * Provides the remote service interface for CommerceDefaultSetting. Methods of this
 * service are expected to have security checks based on the propagated JAAS
 * credentials because this service can be accessed remotely.
 *
 * @author Riccardo Alberti
 * @see CommerceDefaultSettingServiceUtil
 * @generated
 */
@AccessControlled
@JSONWebService
...
public interface CommerceDefaultSettingService extends BaseService {
