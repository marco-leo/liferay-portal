...
const STEPS = [
	{
		subTitle: 'Swagger File',
		title: 'Upload File',
	},
	{
		subTitle: 'Proxy Methods',
		title: 'Select Methods',
	},
	{
		subTitle: 'Proxy Fields',
		title: 'Select Fields',
	},
	{
		subTitle: 'Proxy Mapping',
		title: 'Map',
	},
	{
		subTitle: 'Connection',
...
const DiscoverAPIWizard = forwardRef((props, ref) => {
	...
	const handleSaveConnectionConfiguration = useCallback(
		(connectionConfiguration) => {
			...
			delete configuration.swaggerSpecs;
...
export default DiscoverAPIWizard;
